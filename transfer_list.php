...
where rt.destination_cmp='".$company_allowed."' and rt.status=3 and rt.row_active=1";
    				...
    				while($i<sizeof($arr_trans)){
    					...
    					<tr>
    						...
    						<td><img src="img/stock.png" width="30" height="30"  class="edit_data" onclick="cutting_stock(<?=$arr_trans[$i]["atid"];?>,'<?=basename(__FILE__, '.php');?>');" class="form_acknowledge"></td>
