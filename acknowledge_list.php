...
<html>
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav">
		              ...
		              <ul class="dropdown-menu">
		                ...
		                <li role="menu" class="active"><a href="acknowledge_list.php">รายการรอตอบรับ</a></li>
		              </ul>
		            </li>
    ...
    <div class="content">
    	<div class="inner-content">
    		<table width="100%" id="table_acknowledge_list" class="table-main">
    			<thead>
    				<tr>
    					<td>id</td>
...
where rt.destination_cmp='".$company_allowed."' and rt.status=1 and rt.row_active=1";
...
var table_acknowledge_list=$('#table_acknowledge_list').DataTable({"dom":'<f<t>>',"columnDefs": [{"targets": [0],"visible": false,"searchable": false}],"bPaginate": true,"bPagelength":10,"bSort":true});
