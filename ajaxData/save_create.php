...
$params_save = array($_POST['company_source'],$_POST['div_source'],$_POST['userid'],$_POST['username'],$_POST['company_destination'],$_POST['div_destination'],$_POST['reason'],$_POST['reason_detail'],$_POST['note'],$today,1,1);
